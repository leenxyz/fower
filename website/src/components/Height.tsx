  ...
  return (
    <View>
      ...
      <View row centerY my-20>
        ...
        <input type="range" value={h} max={maxH} min={minH} onChange={(e) => { setH(+e.target.value) }} />
        <View>{h}</View>
      </View>
      <View row centerY my-20>
        <View mr-20>MinHeight Value: </View>
        <input type="range" value={minH} max="100" onChange={(e) => { setMinH(+e.target.value) }} />
        <View>{minH}</View>
      </View>
      <View row centerY my-20>
        <View mr-20>MaxHeight Value: </View>
        <input type="range" value={maxH} max="100" onChange={(e) => { setMaxH(+e.target.value) }} />
        <View>{maxH}</View>
      </View>
    </View>
  )
