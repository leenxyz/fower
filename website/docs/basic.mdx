...
The simplest way to use Styli is to set some Atomic Props directly on the Styli component. The Atomic Props `f-24`, `fontBold`, `green50` will produce the following style:
