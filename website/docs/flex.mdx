...
<div row spaceX3 flexInitial>
  <div bgOrange400 p10>Short</div>
  <div bgOrange400 p10>Medium length</div>
</div>
```
...
```html
<div row spaceX3 flexInitial>
  <div bgOrange400 p4>Short</div>
  <div bgOrange400 p4>Medium length</div>
  <div bgOrange400 p4>
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui ad labore ipsam, aut rem quo
    repellat esse tempore id, quidem
  </div>
...
```html
<div row spaceX3 flexInitial>
  <div bgOrange400 p4 flex="1">Item that can grow or shrink if needed</div>
  <div bgOrange500 p4 flexNone>Item that cannot grow or shrink</div>
  <div bgOrange400 p4 flex="1">Item that can grow or shrink if needed</div>
</div>
```
...
```html
<div row spaceX3 row>
  <div bgOrange400 p4 flex="1"></div>
  <div bgOrange500 p4 flex="2"></div>
  <div bgOrange400 p4 flex="1"></div>
</div>
```
