...
<Box bgGray100 toLeft>
  <Box bgGreen200 s-100 m-0>
    m-0
  </Box>
  <Box bgGreen200 s-100 m={20}>
    m={'{20}'}
  </Box>
  <Box bgGreen200 s-100 m="40px">
    m="40px"
  </Box>
  <Box bgGreen200 s-120 m="10px 20px">
    m="10px 20px"
  </Box>
</Box>
```
...
```jsx live
<Box bgGray100 toLeft>
  <Box ml-10 bgGreen200 s-100>
    ml-10
  </Box>
  <Box mt-10 bgTeal200 s-100>
    mt-10
  </Box>
  <Box mr-10 bgRed200 s-100>
    mr-10
  </Box>
  <Box mb-10 bgYellow200 s-100>
    mb-10
  </Box>
</Box>
```
...
```jsx live
<Box m-20 bgGray200 s-200>
  <Box ml--20 s-100 bgRed500-T60>
    ml--20
  </Box>
  <Box mt="-1rem" s-100 bgOrange400-T60>
    mt="-1rem"
  </Box>
</Box>
```
