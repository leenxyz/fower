...
```jsx live
<Box relative s-160 bgAmber100>
  <Box bgAmber400 s-80 absolute top-20></Box>
</Box>
```
...
```jsx live
<Box relative s-160 bgAmber100>
  <Box bgAmber400 s-80 absolute right={20}></Box>
</Box>
```
...
```jsx live
<Box relative s-160 bgAmber100>
  <Box bgAmber400 s-80 absolute bottom="20%"></Box>
</Box>
```
...
```jsx live
<Box relative s-160 bgAmber100>
  <Box bgAmber400 s-80 absolute left-20></Box>
</Box>
```
...
```jsx live
<Box relative s-160 bgAmber100>
  <Box bgAmber400 s-80 absolute top-20 right--20></Box>
</Box>
```
