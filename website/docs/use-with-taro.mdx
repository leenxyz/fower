...
[Taro](https://taro-docs.jd.com/taro/docs/README/index.html) is a React-like framework，Using Fower in Taro is very similar to using it in React.
...
```jsx title="@fower/taro Source code"
