...
How to use the spacing? Use it by Atomic props like:
...
Spacing can be used in five attributes: `padding`, `margin`, `width`, `height`, `size`, `circle`, for example, you can use these attributes, `p2`, `mx2`, `w4`, `h4`, `s8`, `circle8`, And you can enjoy the perfect type prompt.
