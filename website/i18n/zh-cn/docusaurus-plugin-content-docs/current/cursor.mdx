...
<Box spaceX-10 row white>
  <Box toCenter bgAmber500 rounded-8 square-100 cursorNotAllowed>
    NotAllowed
  </Box>
  <Box toCenter bgAmber500 rounded-8 square-100 cursorPointer>
    Pointer
  </Box>
  <Box toCenter bgAmber500 rounded-8 square-100 cursorGrab>
    Grab
  </Box>
</Box>
```
...
<div spaceX-10 row white>
  <div toCenter bgAmber500 rounded-8 square-100 cursorNotAllowed>NotAllowed</div>
  <div toCenter bgAmber500 rounded-8 square-100 cursorPointer>Pointer</div>
  <div toCenter bgAmber500 rounded-8 square-100 cursorGrab>Grab</div>
</div>
```
...
```jsx live
<Box white toCenter bgAmber500 circle-100 cursor="pointer">
  cursor
</Box>
```
...
```html
<div white toCenter bgAmber500 circle-100 cursor="pointer">cursor</div>
```
