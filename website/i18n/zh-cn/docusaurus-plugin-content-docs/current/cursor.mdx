...
<Box spaceX-10 row white>
  <Box toCenter bgAmber500 rounded-8 s-100 cursorNotAllowed>
    NotAllowed
  </Box>
  <Box toCenter bgAmber500 rounded-8 s-100 cursorPointer>
    Pointer
  </Box>
  <Box toCenter bgAmber500 rounded-8 s-100 cursorGrab>
    Grab
  </Box>
</Box>
```
