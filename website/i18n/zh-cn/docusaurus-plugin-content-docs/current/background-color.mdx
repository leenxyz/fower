...
```jsx live
<Box toEvenly>
  <Box rounded-8 s-100 bgGreen400></Box>
  <Box rounded-8 s-100 bgBlue400></Box>
  <Box rounded-8 s-100 bgPurple400></Box>
</Box>
```
...
```jsx live
<Box toEvenly>
  <Box rounded-8 s-100 bg="#ed8936"></Box>
  <Box rounded-8 s-100 bg="rgba(44,200, 400)"></Box>
  <Box rounded-8 s-100 bg="indigo"></Box>
</Box>
```
