...
describe('styli-plugin-ellipsis', () => {
  ...
  it('onVisitProp', () => {
    ...
    const newAtom1 = {
      propKey: 'ellipsis', propValue: true, style: {
        maxWidth: '100px',
    ...
    const newAtom2 = {
      propKey: 'ellipsis1', propValue: true, style: {
        maxWidth: '100px',
        textOverflow: 'ellipsis',
        overflow: 'hidden',
        whiteSpace: 'nowrap'
    ...
    const newAtom3 = {
      propKey: 'ellipsis-300', propValue: true, style: {
        maxWidth: '300px',
        textOverflow: 'ellipsis',
        overflow: 'hidden',
        whiteSpace: 'nowrap'
    ...
    const newAtom4 = {
      propKey: 'ellipsis2', propValue: true, style: {
        maxWidth: '100px',
        display: '-webkit-box',
    ...
    const newAtom5 = {
      propKey: 'ellipsis6-500', propValue: true, style: {
        maxWidth: '500px',
        display: '-webkit-box',
        WebkitBoxOrient: 'vertical',
        overflow: 'hidden',
